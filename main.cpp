...
int main() {
    ...
    // ------ cria o plantel inicial, listas de lesionados, castigados e transferencias ------
    ...
    exibirMenu(plantel, numJogadoresSort, lesionados, numLesionados, castigados, numCastigados, transferencias, numTransferencias);
